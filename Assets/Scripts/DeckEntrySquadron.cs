...
public class DeckEntrySquadron : DeckEntry, IComparable<DeckEntrySquadron> {
    ...
    [SerializeField] new private CardUnitySquadron card = null;
    new public CardUnitySquadron Card => card;


    public DeckEntrySquadron(CardUnitySquadron squadronCard, int newAmount){
        card = squadronCard;
